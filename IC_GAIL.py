...
for i_episode in range(args.num_epochs):
    ...
    if i_episode % args.log_interval == 0:
        ...
        print('Episode {}\tAverage reward: {:.2f}\tMax reward: {:.2f}\teval_avg_reward: {:.2f}\tloss (disc): {:.2f}'.format(i_episode, np.mean(reward_batch), max(reward_batch), eval_avg_reward, disc_loss.item()))
